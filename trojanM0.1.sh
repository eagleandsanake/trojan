...
if [ "$release" == "centos" ]; then
    ...
    rpm -Uvh https://github.com/eagleandsanake/trojan/raw/master/nginx-release-centos-7-0.el7.ngx.noarch.rpm
...
EOF
	...
	wget https://github.com/eagleandsanake/trojan/raw/master/web.zip
    	unzip web.zip
	...
	#下载trojan客户端
	wget https://github.com/eagleandsanake/trojan/raw/master/trojan-cli.zip
...
EOF
	...
	green "====================================================================="
	green "Trojan已完成安装，以下为配置信息"
	green "您的域名："
	echo  "$your_domain"
	green "您的密码："
	echo  "$trojan_passwd"
	green "------------------------------------------------------------------"
	green "如有需要，点击下列链接，下载已有配置的windows客户端（注意：1H内失效）"
...
start_menu(){
    ...
    green " Modification By myeagleandsnake     "
    green " ===================================="
    echo
    green " 1. 安装trojan"
    red " 2. 卸载trojan"
